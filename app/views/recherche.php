    ...
    <div class="flex justify-center items-center">
        ...
        <div class="w-[80%] bg-white  rounded-lg  overflow-hidden">
            ...
            <div class="divide-y divide-gray-200">
                ...
                <div class="flex items-center p-2 w-full">
                    ...
                    <div class="text-lg  w-[22%]">
                        ...
                        <div class=" text-sm font-semibold  text-gray-300 text-l">Youcode Student</div>
                    </div>
                    ...
                    <form action="/chat" method="post">
                        <a href="/chat/<?= htmlspecialchars($annonce['user_id']) ?>" 
                           class="w-8 h-8 flex items-center justify-center text-indigo-500 bg-indigo-200 rounded-lg cursor-pointer"
            ...
            <div class="flex items-center p-2 w-full">
                ...
                <div
                    class="w-8 h-8 flex items-center justify-center text-orange-500 bg-orange-200 rounded-lg cursor-pointer">
                    <i class="fa-solid fa-angle-right"></i>
                </div>
            </div>
            <?php endif ;?>
