...
<body class="bg-gray-50">
            ...
            <div class="space-y-4">
                ...
                <div id="offerFields" class="space-y-4 hidden">
                    <div>
                        ...
                        <input type="text" name="address" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent" placeholder="Enter your address">
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Places *</label>
                            <input type="number" name="places" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent" placeholder="Number of places">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Room type *</label>
                            <select name="room_type" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="budget" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent" placeholder="Your budget (in Dirham)">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <span>- or -</span>
                        <input type="date" name="availability_date" class="px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#6366F1] focus:border-transparent">
                    </div>
                </div>
    ...
    <script>
        ...
        function setActiveButton(activeBtn, inactiveBtn) {
            ...
            // Show/hide offer-specific fields
